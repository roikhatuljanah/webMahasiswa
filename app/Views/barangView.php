...
<div class="container pt-5">
    ...
    <a href="<?= base_url('barang/cetak'); ?>" class="btn btn-success mb-2">Cetak Data</a>
    <div class="card">
                    ...
                    <tbody>
                        ...
                        foreach ($getBarang as $isi) {
                            ...
                            <tr>
                                ...
                                <td><?= $yudisium; ?></td>
                                <td>
                                    <a href="<?= base_url('barang/edit/' . $isi['nim']); ?>" class="btn btn-success">Edit</a>
                                    <a href="<?= base_url('barang/hapus/' . $isi['nim']); ?>" onclick="return confirm('Apakah ingin menghapus data barang ?')" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php
                            $no++;
